      ...
      <div class="col-12 mb-4">
        ...
        <form action="asd.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="productSlug" name="productSlug" placeholder="Rellena el campo" required>
          </div>
          <div class="mb-3">
            <label for="productFeactures" class="form-label">Caracteristicas</label>
            <input type="text" class="form-control" id="productFeactures" name="productFeactures" placeholder="Rellena el campo" required>
          </div>
      ...
      <?php foreach ($productos as $producto): ?>
        ...
        <div class="col-12 col-md-6 mb-4">
          <div class="card">
            ...
            <form action="eliminar.php" method="post" id="producto-<?= $producto["id"] ?>">
  ...
  <script>
    function deleteProduct(productId) {
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            document.getElementById(`producto-${productId}`).submit();
